...
% steerable analysis
[Q,res] = CompleteAnalysis(A,num_scales,hafun,hdfun,harmonics,prefilter);

% apply U
Qu = Projection(Q,U);

% plot coefficients
PlotWaveletCoeffs(Qu,'allinone');
...
% steerable synthesis
Ar = real(CompleteSynthesis(Qr,hafun,hdfun,harmonics,res));
