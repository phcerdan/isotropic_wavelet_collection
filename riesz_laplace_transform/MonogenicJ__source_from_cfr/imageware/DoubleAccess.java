...
import imageware.DoubleBuffer;
import java.awt.Image;

public class DoubleAccess
extends DoubleBuffer
implements Access {
    protected DoubleAccess(int n, int n2, int n3) {
        super(n, n2, n3);
    }

    protected DoubleAccess(Image image, int n) {
        super(image, n);
    }

    protected DoubleAccess(ImageStack imageStack, int n) {
        super(imageStack, n);
    }

    protected DoubleAccess(ImageStack imageStack, byte by) {
        super(imageStack, by);
    }

    protected DoubleAccess(byte[] arrby, int n) {
        super(arrby, n);
    }
    ...
    protected DoubleAccess(short[] arrs, int n) {
        super(arrs, n);
    }
    ...
    protected DoubleAccess(float[] arrf, int n) {
        super(arrf, n);
    }
    ...
    protected DoubleAccess(double[] arrd, int n) {
        super(arrd, n);
    }
    ...
    public double getPixel(int n, int n2, int n3) {
        ...
        return ((double[])this.data[n3])[n + n2 * this.nx];
    }
    ...
    public double getPixel(int n, int n2, int n3, byte by) {
        ...
        return ((double[])this.data[n5])[n6 + n4 * this.nx];
    }
    ...
    public double getInterpolatedPixel(double d, double d2, double d3) {
        ...
        switch (this.getDimension()) {
            case 1: {
                double d5 = ((double[])this.data[n3])[n4];
                double d6 = bl ? d5 : ((double[])this.data[n3])[n4 + 1];
                double d7 = d - (double)n;
                return d6 * d7 - d5 * (d7 - 1.0);
            }
            case 2: {
                double d8;
                double d9 = ((double[])this.data[n3])[n4];
                double d10 = bl ? d9 : ((double[])this.data[n3])[n4 + 1];
                double d11 = d8 = bl2 ? d9 : ((double[])this.data[n3])[n4 + this.nx];
                double d12 = bl ? (bl2 ? d9 : d8) : ((double[])this.data[n3])[n4 + 1 + this.nx];
            ...
            case 3: {
                ...
                double d17;
                double d18;
                double d19 = ((double[])this.data[n3])[n4];
                double d20 = bl ? d19 : ((double[])this.data[n3])[n4 + 1];
                double d21 = d17 = bl2 ? d19 : ((double[])this.data[n3])[n4 + this.nx];
                double d22 = bl ? (bl2 ? d19 : d17) : ((double[])this.data[n3])[n4 + 1 + this.nx];
                double d23 = d16 = bl3 ? d19 : ((double[])this.data[n3 + 1])[n4];
                double d24 = bl3 ? (bl2 ? d19 : d17) : (d15 = ((double[])this.data[n3 + 1])[n4 + 1]);
                double d25 = bl3 ? (bl ? d19 : d20) : (d18 = ((double[])this.data[n3 + 1])[n4 + this.nx]);
                double d26 = bl3 ? (bl2 ? (bl ? d19 : d20) : d22) : ((double[])this.data[n3 + 1])[n4 + 1 + this.nx];
    ...
    public void putPixel(int n, int n2, int n3, double d) {
        ...
        ((double[])this.data[n3])[n + n2 * this.nx] = d;
    }
    ...
    public void getBoundedX(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            double[] arrd = (double[])this.data[n3];
            for (int i = n4; i < n8; ++i) {
                arrby[i] = (byte)arrd[n5];
                ++n5;
            }
        }
    ...
    public void getBoundedX(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n8 = n + n7 >= this.nx ? this.nx - n : n7;
            double[] arrd2 = (double[])this.data[n3];
            for (int i = n4; i < n8; ++i) {
                arrd[i] = arrd2[n5];
                ++n5;
            }
    ...
    public void getBoundedZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            for (int i = n4; i < n8; ++i) {
                arrby[i] = (byte)((double[])this.data[n5])[n6];
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                arrs[i] = (short)((double[])this.data[n5])[n6];
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                arrf[i] = (float)((double[])this.data[n5])[n6];
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrby[j][i] = (byte)((double[])this.data[n3])[n7];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrs[j][i] = (short)((double[])this.data[n3])[n7];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrf[j][i] = (float)((double[])this.data[n3])[n7];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrd[j][i] = ((double[])this.data[n3])[n7];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXYZ(int n, int n2, int n3, double[][][] arrd) {
        try {
            ...
            int n14 = n3 + n11 >= this.nz ? this.nz - n3 : n11;
            for (int i = n6; i < n14; ++i) {
                double[] arrd2 = (double[])this.data[n7];
                for (int j = n5; j < n13; ++j) {
                    n8 = n + n4 + (n2 + j) * this.nx;
                    for (int k = n4; k < n12; ++k) {
                        arrd[k][j][i] = arrd2[n8];
    ...
    public void getBlockY(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrby[i] = (byte)arrd[n8 + n11 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getBlockY(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrs[i] = (short)arrd[n8 + n11 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getBlockY(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrf[i] = (float)arrd[n8 + n11 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrby[i] = (byte)((double[])this.data[n12])[n11];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrs[i] = (short)((double[])this.data[n12])[n11];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrf[i] = (float)((double[])this.data[n12])[n11];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrd[i] = ((double[])this.data[n12])[n11];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrby[j][i] = (byte)((double[])this.data[n11])[n12 + n7];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrs[j][i] = (short)((double[])this.data[n11])[n12 + n7];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrf[j][i] = (float)((double[])this.data[n11])[n12 + n7];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrd[j][i] = ((double[])this.data[n11])[n12 + n7];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrby[j][i] = (byte)((double[])this.data[n11])[n7 + n12 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrs[j][i] = (short)((double[])this.data[n11])[n7 + n12 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrf[j][i] = (float)((double[])this.data[n11])[n7 + n12 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrd[j][i] = ((double[])this.data[n11])[n7 + n12 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
    ...
    public void getBlockXYZ(int n, int n2, int n3, byte[][][] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                double[] arrd = (double[])this.data[n11];
                for (int j = 0; j < n9; ++j) {
                    int n12;
                    for (n12 = n2 + j; n12 < 0; n12 += n5) {
                    }
    ...
    public void getBlockXYZ(int n, int n2, int n3, double[][][] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                double[] arrd2 = (double[])this.data[n11];
                for (int j = 0; j < n9; ++j) {
                    int n12;
                    for (n12 = n2 + j; n12 < 0; n12 += n5) {
                    }
    ...
    public void getNeighborhoodX(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            n10 *= this.nx;
            int n13 = n - n12 / 2;
            double[] arrd = (double[])this.data[n9];
            for (int i = 0; i < n12; ++i) {
                int n14;
    ...
    public void getNeighborhoodX(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            n10 *= this.nx;
            int n13 = n - n12 / 2;
            double[] arrd2 = (double[])this.data[n9];
            for (int i = 0; i < n12; ++i) {
                int n14;
                for (n14 = n13 + i; n14 < 0; n14 += n4) {
                }
    ...
    public void getNeighborhoodY(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrby[i] = (byte)arrd[n10 + n14 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrs[i] = (short)arrd[n10 + n14 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrf[i] = (float)arrd[n10 + n14 * this.nx];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrby[i] = (byte)((double[])this.data[n15])[n13];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrs[i] = (short)((double[])this.data[n15])[n13];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrf[i] = (float)((double[])this.data[n15])[n13];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrd[i] = ((double[])this.data[n15])[n13];
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrby[j][i] = (byte)((double[])this.data[n15])[n16 + n9];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrs[j][i] = (short)((double[])this.data[n15])[n16 + n9];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrf[j][i] = (float)((double[])this.data[n15])[n16 + n9];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrd[j][i] = ((double[])this.data[n15])[n16 + n9];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrby[j][i] = (byte)((double[])this.data[n15])[n9 + n16 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrs[j][i] = (short)((double[])this.data[n15])[n9 + n16 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrf[j][i] = (float)((double[])this.data[n15])[n9 + n16 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrd[j][i] = ((double[])this.data[n15])[n9 + n16 * this.nx];
                }
            }
        }
        catch (Exception var12_10) {
    ...
    public void getNeighborhoodXYZ(int n, int n2, int n3, byte[][][] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                double[] arrd = (double[])this.data[n16];
                for (int j = 0; j < n11; ++j) {
                    int n17;
    ...
    public void getNeighborhoodXYZ(int n, int n2, int n3, double[][][] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                double[] arrd2 = (double[])this.data[n16];
                for (int j = 0; j < n11; ++j) {
                    int n17;
                    for (n17 = n14 + j; n17 < 0; n17 += n5) {
                    }
    ...
    public void putBoundedZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((double[])this.data[n5])[n6] = arrby[i] & 255;
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((double[])this.data[n5])[n6] = arrs[i] & 65535;
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((double[])this.data[n6])[n7] = arrby[j][i] & 255;
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((double[])this.data[n6])[n7] = arrs[j][i] & 65535;
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((double[])this.data[n6])[n7] = arrf[j][i];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((double[])this.data[n6])[n7] = arrd[j][i];
                    ++n7;
                }
                ++n6;
            }
