...
extends ByteBuffer
implements Access {
    protected ByteAccess(int n, int n2, int n3) {
        super(n, n2, n3);
    }

    protected ByteAccess(Image image, int n) {
        super(image, n);
    }

    protected ByteAccess(ImageStack imageStack, int n) {
        super(imageStack, n);
    }

    protected ByteAccess(ImageStack imageStack, byte by) {
        super(imageStack, by);
    }

    protected ByteAccess(byte[] arrby, int n) {
        super(arrby, n);
    }
    ...
    protected ByteAccess(short[] arrs, int n) {
        super(arrs, n);
    }
    ...
    protected ByteAccess(float[] arrf, int n) {
        super(arrf, n);
    }
    ...
    protected ByteAccess(double[] arrd, int n) {
        super(arrd, n);
    }
    ...
    public double getPixel(int n, int n2, int n3) {
        ...
        return ((byte[])this.data[n3])[n + n2 * this.nx] & 255;
    }
    ...
    public double getPixel(int n, int n2, int n3, byte by) {
        ...
        return ((byte[])this.data[n5])[n6 + n4 * this.nx] & 255;
    }
    ...
    public double getInterpolatedPixel(double d, double d2, double d3) {
        ...
        switch (this.getDimension()) {
            case 1: {
                double d5 = ((byte[])this.data[n3])[n4] & 255;
                double d6 = bl ? d5 : (double)(((byte[])this.data[n3])[n4 + 1] & 255);
                double d7 = d - (double)n;
                return d6 * d7 - d5 * (d7 - 1.0);
            }
            case 2: {
                double d8;
                double d9 = ((byte[])this.data[n3])[n4] & 255;
                double d10 = bl ? d9 : (double)(((byte[])this.data[n3])[n4 + 1] & 255);
                double d11 = d8 = bl2 ? d9 : (double)(((byte[])this.data[n3])[n4 + this.nx] & 255);
                double d12 = bl ? (bl2 ? d9 : d8) : (double)(((byte[])this.data[n3])[n4 + 1 + this.nx] & 255);
            ...
            case 3: {
                ...
                double d17;
                double d18;
                double d19 = ((byte[])this.data[n3])[n4] & 255;
                double d20 = bl ? d19 : (double)(((byte[])this.data[n3])[n4 + 1] & 255);
                double d21 = d17 = bl2 ? d19 : (double)(((byte[])this.data[n3])[n4 + this.nx] & 255);
                double d22 = bl ? (bl2 ? d19 : d17) : (double)(((byte[])this.data[n3])[n4 + 1 + this.nx] & 255);
                double d23 = d16 = bl3 ? d19 : (double)(((byte[])this.data[n3 + 1])[n4] & 255);
                double d24 = bl3 ? (bl2 ? d19 : d17) : (d15 = (double)(((byte[])this.data[n3 + 1])[n4 + 1] & 255));
                double d25 = bl3 ? (bl ? d19 : d20) : (d18 = (double)(((byte[])this.data[n3 + 1])[n4 + this.nx] & 255));
                double d26 = bl3 ? (bl2 ? (bl ? d19 : d20) : d22) : (double)(((byte[])this.data[n3 + 1])[n4 + 1 + this.nx] & 255);
    ...
    public void putPixel(int n, int n2, int n3, double d) {
        ...
        ((byte[])this.data[n3])[n + n2 * this.nx] = (byte)d;
    }
    ...
    public void getBoundedX(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            byte[] arrby2 = (byte[])this.data[n3];
            for (int i = n4; i < n8; ++i) {
                arrby[i] = (byte)(arrby2[n5] & 255);
                ++n5;
            }
        }
    ...
    public void getBoundedX(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n8 = n + n7 >= this.nx ? this.nx - n : n7;
            byte[] arrby = (byte[])this.data[n3];
            for (int i = n4; i < n8; ++i) {
                arrs[i] = (short)(arrby[n5] & 255);
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            for (int i = n4; i < n8; ++i) {
                arrby[i] = (byte)(((byte[])this.data[n5])[n6] & 255);
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                arrs[i] = (short)(((byte[])this.data[n5])[n6] & 255);
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                arrf[i] = ((byte[])this.data[n5])[n6] & 255;
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedZ(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                arrd[i] = ((byte[])this.data[n5])[n6] & 255;
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getBoundedXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrby[j][i] = (byte)(((byte[])this.data[n3])[n7] & 255);
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrs[j][i] = (short)(((byte[])this.data[n3])[n7] & 255);
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrf[j][i] = ((byte[])this.data[n3])[n7] & 255;
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    arrd[j][i] = ((byte[])this.data[n3])[n7] & 255;
                    ++n7;
                }
                ++n6;
            }
    ...
    public void getBoundedXYZ(int n, int n2, int n3, short[][][] arrs) {
        try {
            ...
            int n14 = n3 + n11 >= this.nz ? this.nz - n3 : n11;
            for (int i = n6; i < n14; ++i) {
                byte[] arrby = (byte[])this.data[n7];
                for (int j = n5; j < n13; ++j) {
                    n8 = n + n4 + (n2 + j) * this.nx;
                    for (int k = n4; k < n12; ++k) {
                        arrs[k][j][i] = (short)(arrby[n8] & 255);
                        ++n8;
                    }
                }
                ++n7;
    ...
    public void getBlockX(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrby[i] = (byte)(arrby2[n11 + n8] & 255);
            }
        }
    ...
    public void getBlockY(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrby[i] = (byte)(arrby2[n8 + n11 * this.nx] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getBlockY(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrs[i] = (short)(arrby[n8 + n11 * this.nx] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getBlockY(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrf[i] = arrby[n8 + n11 * this.nx] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getBlockY(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrd[i] = arrby[n8 + n11 * this.nx] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrby[i] = (byte)(((byte[])this.data[n12])[n11] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrs[i] = (short)(((byte[])this.data[n12])[n11] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrf[i] = ((byte[])this.data[n12])[n11] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getBlockZ(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                arrd[i] = ((byte[])this.data[n12])[n11] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrby[j][i] = (byte)(arrby2[n12 + n11] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrs[j][i] = (short)(arrby[n12 + n11] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrby[j][i] = (byte)(((byte[])this.data[n11])[n12 + n7] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrs[j][i] = (short)(((byte[])this.data[n11])[n12 + n7] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrf[j][i] = ((byte[])this.data[n11])[n12 + n7] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrd[j][i] = ((byte[])this.data[n11])[n12 + n7] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrby[j][i] = (byte)(((byte[])this.data[n11])[n7 + n12 * this.nx] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrs[j][i] = (short)(((byte[])this.data[n11])[n7 + n12 * this.nx] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrf[j][i] = ((byte[])this.data[n11])[n7 + n12 * this.nx] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    arrd[j][i] = ((byte[])this.data[n11])[n7 + n12 * this.nx] & 255;
                }
            }
        }
        catch (Exception var12_10) {
    ...
    public void getBlockXYZ(int n, int n2, int n3, byte[][][] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                byte[] arrby2 = (byte[])this.data[n11];
                for (int j = 0; j < n9; ++j) {
                    int n12;
                    for (n12 = n2 + j; n12 < 0; n12 += n5) {
                    }
                    ...
                    for (int k = 0; k < n8; ++k) {
                        ...
                        arrby[k][j][i] = (byte)(arrby2[n13 + n12] & 255);
                    }
                }
            }
        }
            ...
            for (int i = 0; i < n10; ++i) {
                ...
                for (int j = 0; j < n9; ++j) {
                    ...
                    for (int k = 0; k < n8; ++k) {
                        ...
                        arrs[k][j][i] = (short)(arrby[n13 + n12] & 255);
                    }
                }
            }
        }
    ...
    public void getNeighborhoodX(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrby[i] = (byte)(arrby2[n14 + n10] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("X", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getNeighborhoodX(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrs[i] = (short)(arrby[n14 + n10] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("X", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrby[i] = (byte)(arrby2[n10 + n14 * this.nx] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrs[i] = (short)(arrby[n10 + n14 * this.nx] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrf[i] = arrby[n10 + n14 * this.nx] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getNeighborhoodY(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrd[i] = arrby[n10 + n14 * this.nx] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Y", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, byte[] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrby[i] = (byte)(((byte[])this.data[n15])[n13] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrby, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, short[] arrs, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrs[i] = (short)(((byte[])this.data[n15])[n13] & 255);
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrs, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, float[] arrf, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrf[i] = ((byte[])this.data[n15])[n13] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrf, n, n2, n3);
    ...
    public void getNeighborhoodZ(int n, int n2, int n3, double[] arrd, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                arrd[i] = ((byte[])this.data[n15])[n13] & 255;
            }
        }
        catch (Exception var12_10) {
            this.throw_get("Z", "Mirror or periodic boundaray conditions", arrd, n, n2, n3);
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrby[j][i] = (byte)(arrby2[n16 + n15] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrs[j][i] = (short)(arrby[n16 + n15] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrby[j][i] = (byte)(((byte[])this.data[n15])[n16 + n9] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrs[j][i] = (short)(((byte[])this.data[n15])[n16 + n9] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrf[j][i] = ((byte[])this.data[n15])[n16 + n9] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrd[j][i] = ((byte[])this.data[n15])[n16 + n9] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrby[j][i] = (byte)(((byte[])this.data[n15])[n9 + n16 * this.nx] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrs[j][i] = (short)(((byte[])this.data[n15])[n9 + n16 * this.nx] & 255);
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrf[j][i] = ((byte[])this.data[n15])[n9 + n16 * this.nx] & 255;
                }
            }
        }
        catch (Exception var12_10) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    arrd[j][i] = ((byte[])this.data[n15])[n9 + n16 * this.nx] & 255;
                }
            }
        }
        catch (Exception var12_10) {
    ...
    public void getNeighborhoodXYZ(int n, int n2, int n3, byte[][][] arrby, byte by) {
        ...
        try {
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                byte[] arrby2 = (byte[])this.data[n16];
                for (int j = 0; j < n11; ++j) {
                    int n17;
                    ...
                    for (int k = 0; k < n10; ++k) {
                        ...
                        arrby[k][j][i] = (byte)(arrby2[n18 + n17] & 255);
                    }
                }
            }
        }
            ...
            for (int i = 0; i < n12; ++i) {
                ...
                for (int j = 0; j < n11; ++j) {
                    ...
                    for (int k = 0; k < n10; ++k) {
                        ...
                        arrs[k][j][i] = (short)(arrby[n18 + n17] & 255);
                    }
                }
            }
        }
    ...
    public void putBoundedZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((byte[])this.data[n5])[n6] = (byte)(arrby[i] & 255);
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((byte[])this.data[n5])[n6] = (byte)(arrs[i] & 65535);
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedZ(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((byte[])this.data[n5])[n6] = (byte)arrf[i];
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedZ(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n8 = n3 + n7 >= this.nz ? this.nz - n3 : n7;
            for (int i = n4; i < n8; ++i) {
                ((byte[])this.data[n5])[n6] = (byte)arrd[i];
                ++n5;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putBoundedXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((byte[])this.data[n6])[n7] = (byte)(arrby[j][i] & 255);
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((byte[])this.data[n6])[n7] = (byte)(arrs[j][i] & 65535);
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((byte[])this.data[n6])[n7] = (byte)arrf[j][i];
                    ++n7;
                }
                ++n6;
            }
    ...
    public void putBoundedXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            for (int i = n5; i < n11; ++i) {
                n7 = n + n4 + n2 * this.nx;
                for (int j = n4; j < n10; ++j) {
                    ((byte[])this.data[n6])[n7] = (byte)arrd[j][i];
                    ++n7;
                }
                ++n6;
            }
        ...
        try {
            ...
            for (int i = n6; i < n14; ++i) {
                ...
                for (int j = n5; j < n13; ++j) {
                    n8 = n + n4 + (n2 + j) * this.nx;
                    for (int k = n4; k < n12; ++k) {
                        arrby2[n8] = (byte)(arrby[k][j][i] & 255);
                        ++n8;
                    }
                }
                ++n7;
        ...
        try {
            ...
            for (int i = n6; i < n14; ++i) {
                ...
                for (int j = n5; j < n13; ++j) {
                    n8 = n + n4 + (n2 + j) * this.nx;
                    for (int k = n4; k < n12; ++k) {
                        arrby[n8] = (byte)(arrs[k][j][i] & 65535);
                        ++n8;
                    }
                }
                ++n7;
