...
implements Buffer {
    ...
    protected ByteBuffer(int n, int n2, int n3) {
        this.nx = n;
        this.ny = n2;
        this.nz = n3;
        if (n <= 0 || n2 <= 0 || n3 <= 0) {
    ...
    protected ByteBuffer(Image image, int n) {
        if (image == null) {
        ...
        for (int i = 0; i < this.nxy; ++i) {
            ((byte[])this.data[0])[i] = (byte)(arrby[i] & 255);
        }
    }

    protected ByteBuffer(ImageStack imageStack, int n) {
        if (imageStack == null) {
            this.throw_constructor();
        }
            ...
            case 1: {
                ...
                if (imageProcessor instanceof ByteProcessor) {
                    ...
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ((byte[])this.data[i])[j] = (byte)(arrby[j] & 255);
                        }
                    }
                    break;
                }
                if (imageProcessor instanceof ShortProcessor) {
                    ...
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ((byte[])this.data[i])[j] = (byte)(arrs[j] & 65535);
                        }
                    }
                    break;
                }
                ...
                if (imageProcessor instanceof ColorProcessor) {
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ...
                            double d3 = n2 & 255;
                            ((byte[])this.data[i])[j] = (byte)((d + d2 + d3) / 3.0);
                        }
                    }
                    break;
                }
    ...
    protected ByteBuffer(ImageStack imageStack, byte by) {
        if (imageStack == null) {
            this.throw_constructor();
        }
        this.nx = imageStack.getWidth();
                ...
                switch (by) {
                    ...
                    case 0: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((byte[])this.data[i])[n] = (byte)((arrn[n] & 16711680) >> 16);
                        }
                        continue block11;
                    }
                    case 1: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((byte[])this.data[i])[n] = (byte)((arrn[n] & 65280) >> 8);
                        }
                        continue block11;
                    }
                    case 2: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((byte[])this.data[i])[n] = (byte)(arrn[n] & 255);
                        }
                        continue block11;
                    }
                    default: {
    ...
    protected ByteBuffer(byte[] arrby, int n) {
        if (arrby == null) {
            this.throw_constructor();
        }
    ...
    protected ByteBuffer(short[] arrs, int n) {
        if (arrs == null) {
            this.throw_constructor();
        }
        this.nx = arrs.length;
    ...
    protected ByteBuffer(float[] arrf, int n) {
        if (arrf == null) {
            this.throw_constructor();
        }
        this.nx = arrf.length;
    ...
    protected ByteBuffer(double[] arrd, int n) {
        if (arrd == null) {
            this.throw_constructor();
        }
        this.nx = arrd.length;
    ...
    public void putX(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            System.arraycopy(arrby, 0, arrby2, n4, n5);
        }
    ...
    public void putZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n5 = arrby.length;
            for (int i = 0; i < n5; ++i) {
                ((byte[])this.data[n3])[n4] = (byte)(arrby[i] & 255);
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n5 = arrs.length;
            for (int i = 0; i < n5; ++i) {
                ((byte[])this.data[n3])[n4] = (byte)(arrs[i] & 65535);
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n5 = arrf.length;
            for (int i = 0; i < n5; ++i) {
                ((byte[])this.data[n3])[n4] = (byte)arrf[i];
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n5 = arrd.length;
            for (int i = 0; i < n5; ++i) {
                ((byte[])this.data[n3])[n4] = (byte)arrd[i];
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((byte[])this.data[n3])[n4] = (byte)(arrby[n8][n7] & 255);
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((byte[])this.data[n3])[n4] = (byte)(arrs[n8][n7] & 65535);
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((byte[])this.data[n3])[n4] = (byte)arrf[n8][n7];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((byte[])this.data[n3])[n4] = (byte)arrd[n8][n7];
                    ++n8;
                    ++n4;
                }
                ++n7;
        ...
        try {
            ...
            while (n8 < n7) {
                ...
                for (int i = 0; i < n6; ++i) {
                    ...
                    int n9 = 0;
                    while (n9 < n5) {
                        arrby2[n4] = (byte)(arrby[n9][i][n8] & 255);
                        ++n9;
                        ++n4;
                    }
                }
        ...
        try {
            ...
            while (n8 < n7) {
                ...
                for (int i = 0; i < n6; ++i) {
                    ...
                    int n9 = 0;
                    while (n9 < n5) {
                        arrby[n4] = (byte)(arrs[n9][i][n8] & 65535);
                        ++n9;
                        ++n4;
                    }
                }
    ...
    public void getX(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n5 = arrby.length;
            byte[] arrby2 = (byte[])this.data[n3];
            System.arraycopy(arrby2, n4, arrby, 0, n5);
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n5 = arrby.length;
            for (int i = 0; i < n5; ++i) {
                arrby[i] = (byte)(((byte[])this.data[n3])[n4] & 255);
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n5 = arrs.length;
            for (int i = 0; i < n5; ++i) {
                arrs[i] = (short)(((byte[])this.data[n3])[n4] & 255);
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n5 = arrf.length;
            for (int i = 0; i < n5; ++i) {
                arrf[i] = ((byte[])this.data[n3])[n4] & 255;
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n5 = arrd.length;
            for (int i = 0; i < n5; ++i) {
                arrd[i] = ((byte[])this.data[n3])[n4] & 255;
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrby[n8][n7] = (byte)(((byte[])this.data[n3])[n4] & 255);
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrs[n8][n7] = (short)(((byte[])this.data[n3])[n4] & 255);
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrf[n8][n7] = ((byte[])this.data[n3])[n4] & 255;
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrd[n8][n7] = ((byte[])this.data[n3])[n4] & 255;
                    ++n8;
                    ++n4;
                }
                ++n7;
        ...
        try {
            ...
            while (n8 < n7) {
                ...
                for (int i = 0; i < n6; ++i) {
                    ...
                    int n9 = 0;
                    while (n9 < n5) {
                        arrby[n9][i][n8] = (byte)(arrby2[n4] & 255);
                        ++n9;
                        ++n4;
                    }
                }
        ...
        try {
            ...
            while (n8 < n7) {
                ...
                for (int i = 0; i < n6; ++i) {
                    ...
                    int n9 = 0;
                    while (n9 < n5) {
                        arrs[n9][i][n8] = (short)(arrby[n4] & 255);
                        ++n9;
                        ++n4;
                    }
                }
    ...
    protected void throw_constructor(int n, int n2, int n3) {
        throw new ArrayStoreException("\n-------------------------------------------------------\nError in imageware package\nUnable to create a byte imageware " + n + "," + n2 + "," + n3 + "].\n" + "-------------------------------------------------------\n");
    }
