...
implements ImageWare {
    ...
    protected DoubleSet(byte[] arrby, int n) {
        super(arrby, n);
    }
    ...
    protected DoubleSet(short[] arrs, int n) {
        super(arrs, n);
    }
    ...
    protected DoubleSet(float[] arrf, int n) {
        super(arrf, n);
    }
    ...
    protected DoubleSet(double[] arrd, int n) {
        super(arrd, n);
    }
    ...
    public ImageWare duplicate() {
        ...
        for (int i = 0; i < this.nz; ++i) {
            double[] arrd = (double[])doubleSet.data[i];
            System.arraycopy(this.data[i], 0, arrd, 0, this.nxy);
        }
        return doubleSet;
    }
    ...
    public void copy(ImageWare imageWare) {
        ...
        for (int i = 0; i < this.nz; ++i) {
            ...
            System.arraycopy(arrd, 0, this.data[i], 0, this.nxy);
        }
    }
    ...
    public ImageWare convert(int n) {
        ...
        switch (n) {
            ...
            case 4: {
                ...
                for (int i = 0; i < this.nz; ++i) {
                    double[] arrd = (double[])this.data[i];
                    double[] arrd2 = (double[])((DoubleSet)imageWare).data[i];
                    for (int j = 0; j < this.nxy; ++j) {
                        arrd2[j] = arrd[j];
                    }
                }
