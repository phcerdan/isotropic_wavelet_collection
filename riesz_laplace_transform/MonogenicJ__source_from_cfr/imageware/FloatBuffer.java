...
implements Buffer {
    ...
    protected FloatBuffer(int n, int n2, int n3) {
        this.nx = n;
        this.ny = n2;
        this.nz = n3;
        if (n <= 0 || n2 <= 0 || n3 <= 0) {
    ...
    protected FloatBuffer(Image image, int n) {
        if (image == null) {
        ...
        for (int i = 0; i < this.nxy; ++i) {
            ((float[])this.data[0])[i] = arrby[i] & 255;
        }
    }

    protected FloatBuffer(ImageStack imageStack, int n) {
        if (imageStack == null) {
            this.throw_constructor();
        }
            ...
            case 1: {
                ...
                if (imageProcessor instanceof ByteProcessor) {
                    ...
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ((float[])this.data[i])[j] = arrby[j] & 255;
                        }
                    }
                    break;
                }
                if (imageProcessor instanceof ShortProcessor) {
                    ...
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ((float[])this.data[i])[j] = arrs[j] & 65535;
                        }
                    }
                    break;
                }
                ...
                if (imageProcessor instanceof ColorProcessor) {
                    for (int i = 0; i < this.nz; ++i) {
                        ...
                        for (int j = 0; j < this.nxy; ++j) {
                            ...
                            double d3 = n2 & 255;
                            ((float[])this.data[i])[j] = (float)((d + d2 + d3) / 3.0);
                        }
                    }
                    break;
                }
    ...
    protected FloatBuffer(ImageStack imageStack, byte by) {
        if (imageStack == null) {
            this.throw_constructor();
        }
        this.nx = imageStack.getWidth();
                ...
                switch (by) {
                    ...
                    case 0: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((float[])this.data[i])[n] = (arrn[n] & 16711680) >> 16;
                        }
                        continue block11;
                    }
                    case 1: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((float[])this.data[i])[n] = (arrn[n] & 65280) >> 8;
                        }
                        continue block11;
                    }
                    case 2: {
                        for (n = 0; n < this.nxy; ++n) {
                            ((float[])this.data[i])[n] = arrn[n] & 255;
                        }
                        continue block11;
                    }
                    default: {
    ...
    protected FloatBuffer(byte[] arrby, int n) {
        if (arrby == null) {
            this.throw_constructor();
        }
    ...
    protected FloatBuffer(short[] arrs, int n) {
        if (arrs == null) {
            this.throw_constructor();
        }
        this.nx = arrs.length;
    ...
    protected FloatBuffer(float[] arrf, int n) {
        if (arrf == null) {
            this.throw_constructor();
        }
        this.nx = arrf.length;
    ...
    protected FloatBuffer(double[] arrd, int n) {
        if (arrd == null) {
            this.throw_constructor();
        }
        this.nx = arrd.length;
    ...
    public void putX(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            System.arraycopy(arrf, 0, arrf2, n4, n5);
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n5 = arrby.length;
            for (int i = 0; i < n5; ++i) {
                ((float[])this.data[n3])[n4] = arrby[i] & 255;
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n5 = arrs.length;
            for (int i = 0; i < n5; ++i) {
                ((float[])this.data[n3])[n4] = arrs[i] & 65535;
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, float[] arrf) {
        try {
            int n4 = n + n2 * this.nx;
            for (float ((float[])this.data[n3])[n4] : arrf) {
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putZ(int n, int n2, int n3, double[] arrd) {
        try {
            ...
            int n5 = arrd.length;
            for (int i = 0; i < n5; ++i) {
                ((float[])this.data[n3])[n4] = (float)arrd[i];
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void putXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((float[])this.data[n3])[n4] = arrby[n8][n7] & 255;
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((float[])this.data[n3])[n4] = arrs[n8][n7] & 65535;
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((float[])this.data[n3])[n4] = arrf[n8][n7];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void putXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    ((float[])this.data[n3])[n4] = (float)arrd[n8][n7];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getX(int n, int n2, int n3, float[] arrf) {
        try {
            ...
            int n5 = arrf.length;
            float[] arrf2 = (float[])this.data[n3];
            System.arraycopy(arrf2, n4, arrf, 0, n5);
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, byte[] arrby) {
        try {
            ...
            int n5 = arrby.length;
            for (int i = 0; i < n5; ++i) {
                arrby[i] = (byte)((float[])this.data[n3])[n4];
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getZ(int n, int n2, int n3, short[] arrs) {
        try {
            ...
            int n5 = arrs.length;
            for (int i = 0; i < n5; ++i) {
                arrs[i] = (short)((float[])this.data[n3])[n4];
                ++n3;
            }
        }
        catch (Exception var5_6) {
    ...
    public void getXZ(int n, int n2, int n3, byte[][] arrby) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrby[n8][n7] = (byte)((float[])this.data[n3])[n4];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, short[][] arrs) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrs[n8][n7] = (short)((float[])this.data[n3])[n4];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, float[][] arrf) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrf[n8][n7] = ((float[])this.data[n3])[n4];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    public void getXZ(int n, int n2, int n3, double[][] arrd) {
        try {
            ...
            while (n7 < n6) {
                ...
                int n8 = 0;
                while (n8 < n5) {
                    arrd[n8][n7] = ((float[])this.data[n3])[n4];
                    ++n8;
                    ++n4;
                }
                ++n7;
    ...
    protected void throw_constructor(int n, int n2, int n3) {
        throw new ArrayStoreException("\n-------------------------------------------------------\nError in imageware package\nUnable to create a float imageware " + n + "," + n2 + "," + n3 + "].\n" + "-------------------------------------------------------\n");
    }
    ...
    private void allocate() {
        try {
            ...
            this.nxy = this.nx * this.ny;
            for (int i = 0; i < this.nz; ++i) {
                this.data[i] = new float[this.nxy];
            }
        }
