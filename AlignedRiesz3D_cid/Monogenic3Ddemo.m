function [Q R orientations] = Monogenic3Ddemo(A)
%RIESZ3DDEMO demonstrate the 3D monogenic analysis with the Riesz transform
%
%  [Q residual orientations] = Monogenic3Ddemo(A) demonstrates the 3D
...
%
%  [Q residual orientations] = Monogenic3Ddemo() demonstrates the 3D
...
config = RieszConfig(size(A), rieszOrder, numWaveletScales, 1, 1);
